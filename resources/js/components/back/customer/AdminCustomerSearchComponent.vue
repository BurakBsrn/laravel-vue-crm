        ...
        <div class="container-fluid">
                                        ...
                                        <form class="theme-form">
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            <label class="col-form-label pt-0" for="exampleInputEmail1">Müşteri Ara</label>
                                                            <input class="form-control" id="exampleInputEmail1" v-model="customer_name"
                                                                   type="text" aria-describedby="emailHelp" placeholder="Müşteri Adı">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <pagination :data="items" @pagination-change-page="searchCustomer"></pagination>
...
<script>
export default {
    name: "AdminCustomerSearchComponent",
    created() {
        if (!User.loggedIn()) {
    ...
    methods :  {
        async searchCustomer(page = 1){
            const res = await this.callApi("get","/api/customer/search?aranan="+this.customer_name+"&page="+page,{
                aranan : this.customer_name
            },{
