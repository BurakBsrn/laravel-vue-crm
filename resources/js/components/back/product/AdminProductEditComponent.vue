                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <span>Güncellemek istediğiniz ürün bilgilerini eksiksiz olarak giriniz</span>
                                    </div>
                                    <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <span class="text-danger" v-if="errors.product_category_id">{{
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <span class="text-danger" v-if="errors.product_model_code">{{
                                                                    errors.product_model_code[0]
                                                                }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <span class="text-danger" v-if="errors.product_barcode">{{
                                                                    errors.product_barcode[0]
                                                                }}</span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <span class="text-danger" v-if="errors.product_brand">{{
                                                                    errors.product_brand[0]
                                                                }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <span class="text-danger" v-if="errors.product_stock">{{
                                                                    errors.product_stock[0]
                                                                }}</span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <span class="text-danger" v-if="errors.product_tax">{{
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control" id="exampleInputEmail1"
                                                                   ...
                                                                   v-model="form.product_buying_price"
                                                                   aria-describedby="emailHelp"
                                                                   placeholder="Ürün Alış Fiyatı">
                                                            <span class="text-danger"
                                                                  v-if="errors.product_buying_price">{{
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <span class="text-danger"
                                                                  v-if="errors.product_selling_price">{{
                                                        ...
                                                        <div class="row" v-for="(item,index) in getPropertyElements">
                                                            <div class="col-md-5 mt-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                       :value="item.property" name="property"
                                                                       @keyup="propertyNameInput(index,$event)">
                                                            </div>
                                    ...
                                    <div class="card-footer text-end">
                                        ...
                                        <router-link :to="{name : 'admin_products'}"
                                                     class="btn btn-secondary text-white"><i class="fa fa-arrow-left"></i> Ürünler
                                        </router-link>
                                    </div>
                                </div>
                            </div>
...
export default {
    name: "AdminProductEditComponent",
    async created() {
        if (!User.loggedIn()) {
    ...
    methods : {
        ...
        async getProduct(product_id){
            const res = await this.callApi("get","/api/product/"+product_id+"/edit",{},{
                "Authorization" : "Bearer "+AppStorage.getToken(),
            });
            ...
            if (res.status==200){
                this.form = {
                    ...
                    propertyElements: res.data.property,
                }
            }else{
                Notification.error();
         ...
         async updateProduct(){
            ...
            const res = await this.callApi("post","/api/product/"+product_id+"/update",formData,{
                "Authorization" : "Bearer "+AppStorage.getToken()
            });
